<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminUserPage.aspx.cs" Inherits="Final_Year_Project.AdminPage" %>
...
<body style="background-color: lightgrey">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label2" runat="server" Style="z-index: 1; left: 191px; top: 106px; position: absolute; height: 36px; width: 607px;" Text="Admin User Page" Font-Names="Calibri" Font-Size="XX-Large" BackColor="Silver" ForeColor="White"></asp:Label>
        <asp:ListBox ID="lstUser" runat="server" Style="z-index: 1; left: 448px; top: 203px; position: absolute; height: 200px; width: 288px"></asp:ListBox>
        ...
        <asp:Button ID="Button1" runat="server" BackColor="#999999" OnClick="Button1_Click" style="z-index: 1; left: 56px; top: 163px; position: absolute" Text="Go Back" />
