<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HealthSpecViewPosts.aspx.cs" Inherits="Final_Year_Project.HealthSpecViewPosts" %>
...
<body style="background-color: lightgrey">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label2" runat="server" BackColor="#FFCC00" Font-Names="Calibri" Font-Size="X-Large" ForeColor="Black" style="z-index: 1; left: 360px; top: 101px; position: absolute; height: 35px; width: 553px" Text="View Posts"></asp:Label>
