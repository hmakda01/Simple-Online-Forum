<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteUser.aspx.cs" Inherits="Final_Year_Project.DeleteUser" %>
...
<body style="background-color: lightgrey">
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnYES" runat="server" OnClick="btnYES_Click" style="z-index: 1; left: 134px; top: 118px; position: absolute; height: 26px; width: 70px" Text="Yes" />
