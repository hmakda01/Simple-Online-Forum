<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserEdit.aspx.cs" Inherits="Final_Year_Project.UserEdit" %>
...
<body style="background-color: lightgrey">
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtFirstName" runat="server"  style="z-index: 1; left: 630px; top: 204px; position: absolute" ></asp:TextBox>
        <asp:TextBox ID="txtLastName" runat="server"  style="z-index: 1; left: 630px; top: 235px; position: absolute"></asp:TextBox>
         <asp:TextBox ID="txtEmail" runat="server" style="z-index: 1; left: 630px; top: 304px; position: absolute"></asp:TextBox>
         <asp:TextBox ID="txtUserPasword" runat="server" style="z-index: 1; left: 630px; top: 346px; position: absolute"></asp:TextBox>
