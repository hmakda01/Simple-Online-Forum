<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewPosts.aspx.cs" Inherits="Final_Year_Project.ViewPosts" %>
...
<body style="background-color: lightgrey">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label2" runat="server" BackColor="#6600FF" Font-Names="Calibri" Font-Size="X-Large" ForeColor="White" style="z-index: 1; left: 360px; top: 101px; position: absolute; height: 35px; width: 553px" Text="View Posts"></asp:Label>
        ...
        <asp:Button ID="btnResponse" runat="server" OnClick="Button2_Click" style="z-index: 1; left: 846px; top: 431px; position: absolute; height: 35px; width: 172px;" Text="View Responses" BackColor="#CCFFCC" Font-Names="Calibri" Font-Size="X-Large" ForeColor="Black" />
