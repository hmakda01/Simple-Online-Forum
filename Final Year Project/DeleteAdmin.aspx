<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteAdmin.aspx.cs" Inherits="Final_Year_Project.DeleteAdmin" %>
...
<body style="background-color: lightgrey">
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnNo" runat="server" style="z-index: 1; left: 254px; top: 118px; position: absolute; width: 70px" Text="No" />
