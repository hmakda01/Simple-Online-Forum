<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminEditAdmin.aspx.cs" Inherits="Final_Year_Project.AdminEditAdmin" %>
...
<body style="background-color: lightgrey">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="L" runat="server" Font-Bold="True" Font-Size="32pt" style="z-index: 1; left: 11px; top: 17px; position: absolute; height: 57px; width: 1140px" Text="COVID CONVERSATIONS" BackColor="#33CCFF" ForeColor="Black"></asp:Label>
         ...
         <asp:Label ID="Lk" runat="server" BackColor="#9BBCFF" style="z-index: 1; left: 266px; top: 177px; position: absolute; height: 273px; width: 696px"></asp:Label>
        <asp:Label ID="Label2" runat="server" style="z-index: 1; left: 518px; top: 128px; position: absolute; height: 26px; width: 121px;" Text="Edit Admin"></asp:Label>
        ...
        <asp:Label ID="Label7" runat="server" style="z-index: 1; left: 369px; top: 344px; position: absolute; width: 253px; height: 24px;" Text="Password" BackColor="White"></asp:Label>
        <asp:TextBox ID="txtAdminPassword" runat="server" style="z-index: 1; left: 631px; top: 344px; position: absolute; margin-top: 1px;"></asp:TextBox>
 </form>
</body>
</html>
