<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewPost.aspx.cs" Inherits="Final_Year_Project.AddNewPost" %>
...
<body style="background-color: lightgrey">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label2" runat="server" BackColor="Gray" Font-Names="Calibri" Font-Size="Larger" ForeColor="White" style="z-index: 1; left: 345px; top: 105px; position: absolute; height: 26px; width: 531px" Text="Add new Post"></asp:Label>
        ...
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 267px; top: 437px; position: absolute"></asp:Label>
